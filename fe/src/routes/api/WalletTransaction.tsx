...
export default function WalletTxnConfirmation() {
  ...
  async function checkSession() {
    ...
    if (result == true) {
      ...
      try {
        let txnValidation: TxnValidationResponse = await vaultSDK.txnValidation(
          transactions,
          mService.origin
        );
            ...
            >
              ...
              {success ? (
                <Grid
                  ...
                  justifyContent="center"
                  alignItems="center"
                  sx={{ "text-align": "left", display: "inline-flex" }}
                >
                  <img src={TxApproveLogo} width="40" height="40" />
                ...
                <Grid
                  ...
                  sx={{ "text-align": "left", display: "inline-flex" }}
                >
                  <img src={TxConfirmLogo} width="40" height="40" />
                  <Typography sx={{ m: 1 }}>Approve Transaction?</Typography>
                </Grid>
              )}
            </Grid>
          ...
          <Grid container spacing={1}>
            {payment && (
              <>
                ...
                <Grid item xs={12}>
                  <Typography variant="subtitle2">{payment.iat}</Typography>
                </Grid>
                <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <Typography variant="caption">
                Send from my account "{validation?.alias}" to{" "}
                {validation?.origin}
              </Typography>
            </Grid>
          </Grid>
