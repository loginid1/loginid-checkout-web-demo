...
import { Chip, Popper, MenuItem } from '@mui/material';
...
function DashboardContent() {
  ...
  const [username, setUsername] = React.useState(wallet.getAccount());
  const [logout, setLogout] = React.useState(false);
  const [anchorLogout, setAnchorLogout] = React.useState<any|null>(null)
  const toggleDrawer = () => {
    setOpen(!open);
  };
  const handleLogout = () => {
