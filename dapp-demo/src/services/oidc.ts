import { AuthorizationNotifier, AuthorizationRequestHandler, TokenRequestHandler, AuthorizationServiceConfiguration, AuthorizationRequest, AuthorizationResponse, TokenResponse, RedirectRequestHandler, BaseTokenRequestHandler, log, TokenRequest, StringMap, GRANT_TYPE_AUTHORIZATION_CODE, GRANT_TYPE_REFRESH_TOKEN, FetchRequestor, AuthorizationServiceConfigurationJson } from "@openid/appauth";
...
export class OidcService {
  ...
  fetchServiceConfiguration() {
    ...
    const requestor= new FetchRequestor();
    AuthorizationServiceConfiguration.fetchFromIssuer(openIdConnectUrl, new FetchRequestor())
        .then(response => {
  ...
  async makeTokenRequest(code : string) {
